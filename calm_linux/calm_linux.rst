...
#. Fill out the following fields under the VM section:
...
#. Select the **WebServer** service in the blueprint editor, then select the **Package** tab and click **Configure uninstall**.
...
#. Select the **HAProxy** service in the blueprint editor, then select the **Package** tab and click **Configure uninstall**.
